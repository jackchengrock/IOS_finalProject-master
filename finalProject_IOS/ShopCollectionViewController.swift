...
class ShopCollectionViewController: UICollectionViewController {
    ...
    let images = ["images1","images2","images3","images4","images5","images6","images7","images8","images9","images10","images11","images12","images13","images14","images15"]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let indexPath = collectionView.indexPath(for: cell){
            let controller = segue.destination as? collectionDetailViewController
            controller?.picName = indexPath.row
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // Configure the cell
        cell.pic.image = UIImage(named: images[indexPath.row])
